...
public class AceHeader {
    ...
    private Set<AceFlag> aceFlags;
    private int aceSize;

    AceHeader() {
    }

    AceHeader(AceType aceType, Set<AceFlag> aceFlags) {
    ...
    static AceHeader readFrom(SMBBuffer buffer) throws Buffer.BufferException {
        ...
        Set<AceFlag> aceFlags = toEnumSet(buffer.readByte(), AceFlag.class);
    ...
    public Set<AceFlag> getAceFlags() {
        return aceFlags;
    }
