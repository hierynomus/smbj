    ...
    public static Ace read(SMBBuffer buffer) throws Buffer.BufferException {
        ...
        switch (header.getAceType()) {
            case ACCESS_ALLOWED_ACE_TYPE:
                ace = BasicAce.read(header, buffer);
                break;
            case ACCESS_ALLOWED_CALLBACK_ACE_TYPE:
                ace = CallbackAce.read(header, buffer, startPos);
                break;
            case ACCESS_ALLOWED_CALLBACK_OBJECT_ACE_TYPE:
                ace = ObjectCallbackAce.read(header, buffer, startPos);
                break;
            case ACCESS_ALLOWED_OBJECT_ACE_TYPE:
                ace = ObjectAce.read(header, buffer, startPos);
                break;
