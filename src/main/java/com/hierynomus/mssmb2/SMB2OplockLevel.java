...
/**
 * SMB2 oplock level — the single-byte {@code RequestedOplockLevel} (CREATE request) /
 * {@code OplockLevel} (CREATE response) field ([MS-SMB2] 2.2.13 / 2.2.14).
 * {@code LEASE = 0xFF} means "an {@code RqLs} lease create context is present".
 */
