...
public class FileIdFullDirectoryInformation extends FileDirectoryQueryableInformation {
    ...
    public FileIdFullDirectoryInformation(long nextOffset, long fileIndex, String fileName, FileTime creationTime, FileTime lastAccessTime, FileTime lastWriteTime, FileTime changeTime, long endOfFile, long allocationSize, long fileAttributes, long eaSize, byte[] fileId) {
