...
public class FileIdBothDirectoryInformation extends FileDirectoryQueryableInformation {
    ...
    public FileIdBothDirectoryInformation(long nextOffset, long fileIndex, String fileName, FileTime creationTime, FileTime lastAccessTime, FileTime lastWriteTime, FileTime changeTime, long endOfFile, long allocationSize, long fileAttributes, long eaSize, String shortName, byte[] fileId) {
